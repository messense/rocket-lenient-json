...
/// rocket_lenient_json` invocation:
///
/// ```rust,ignore
/// #[macro_use] extern crate rocket_lenient_json;
/// ```
///
/// The return type of a `json!` invocation is
/// [`JsonValue`](struct.JsonValue.html). A value created with
